...
public class AmbulanceMapActivity extends AppCompatActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ambulance Map");

        drawerLayout = findViewById(R.id.drawable_layout_ambulanceMap);
        actionBarDrawerToggle = new ActionBarDrawerToggle(AmbulanceMapActivity.this, drawerLayout, R.string.drawer_open, R.string.drawer_close);
    ...
    private void SendUserToLoginActivity() {
        ...
        Intent loginIntent = new Intent(AmbulanceMapActivity.this, LoginActivity.class);
    ...
    private void SendUserToHome(){
        ...
        Intent homeIntent = new Intent(AmbulanceMapActivity.this, MainActivity.class);
    ...
    private void SendUserToEmergency(){
        ...
        Intent emergencyIntent = new Intent(AmbulanceMapActivity.this, EmergencyLayout.class);
    ...
    private void SendUserToProfile(){
        ...
        Intent profileIntent = new Intent(AmbulanceMapActivity.this, ProfileActivity.class);
