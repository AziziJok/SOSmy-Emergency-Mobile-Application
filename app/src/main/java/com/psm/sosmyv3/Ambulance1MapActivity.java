...
public class Ambulance1MapActivity extends AppCompatActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance1_map);
        ...
        drawerLayout = findViewById(R.id.drawable_layout_ambulance1Map);
        actionBarDrawerToggle = new ActionBarDrawerToggle(Ambulance1MapActivity.this, drawerLayout, R.string.drawer_open, R.string.drawer_close);
    ...
    private void SendUserToLoginActivity() {
        ...
        Intent loginIntent = new Intent(Ambulance1MapActivity.this, LoginDispatch.class);
    ...
    private void SendUserToHome(){
        ...
        Intent homeIntent = new Intent(Ambulance1MapActivity.this, Ambulance1MapActivity.class);
    ...
    private void SendUserToProfile(){
        ...
        Intent profileIntent = new Intent(Ambulance1MapActivity.this, DispatchProfileActivity.class);
