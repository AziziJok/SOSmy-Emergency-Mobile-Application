...
public class PoliceMapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Police Map");

        drawerLayout = findViewById(R.id.drawable_layout_policeMap);
        actionBarDrawerToggle = new ActionBarDrawerToggle(PoliceMapActivity.this, drawerLayout, R.string.drawer_open, R.string.drawer_close);
    ...
    public void onLocationChanged(Location location) {
        if (getApplicationContext() !=null){
            ...
            DatabaseReference refAvailable = FirebaseDatabase.getInstance().getReference("policeAvailable");
            DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("policeWorking");
    ...
    protected void onStop() {
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("policeAvailable");
    ...
    private void SendUserToLoginActivity() {
        ...
        Intent loginIntent = new Intent(PoliceMapActivity.this, LoginDispatch.class);
    ...
    private void SendUserToHome(){
        ...
        Intent homeIntent = new Intent(PoliceMapActivity.this, PoliceMapActivity.class);
    ...
    private void SendUserToProfile(){
        ...
        Intent profileIntent = new Intent(PoliceMapActivity.this, DispatchProfileActivity.class);
